...
def check_menu(ai_settings, screen, stats, sb, menu, ship, aliens, bullets, mouse_x, mouse_y):
    """Start a new game when the player clicks Play."""
    if menu.play_button.clicked((mouse_x, mouse_y)):
...
def play_bg_music(ai_settings):
    ...
    bg_music = pygame.mixer.music.load('sound/bg_music.mp3')
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, menu):
    ...
    screen.blit(ai_settings.bg_image, (0, 0))  # Draw the background image
...
def fire_bullet(ai_settings, screen, ship, bullets):
    ...
    fire_sfx = pygame.mixer.Sound('sound/shoot.wav')
...
def start_new_level(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """ Starts a new level. """
    next_level_sfx = pygame.mixer.Sound('sound/next_level.wav')
...
def check_high_scores(ai_settings, stats, sb):
    ...
    new_hs_sfx = pygame.mixer.Sound('sound/high_score.wav')
...
def ship_hit(ai_settings, stats, sb, menu, screen, ship, aliens, bullets):
    ...
    ship_hit_sfx = pygame.mixer.Sound('sound/ship_hit.wav')
    game_over_sfx = pygame.mixer.Sound('sound/game_over.wav')
    ...
    if stats.ships_left > 0:
        ...
        stats.ships_left -= 1
        sb.prep_ships()
        # Reset ship position to center bottom
        ship.center_ship()
